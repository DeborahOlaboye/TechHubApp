"""
Django settings for TechHubWebsite project.
...
DEBUG = False
ALLOWED_HOSTS = ['techhubwebapplication.onrender.com', '127.0.0.1', 'localhost']
...
WSGI_APPLICATION = 'TechHubWebsite.wsgi.application'
